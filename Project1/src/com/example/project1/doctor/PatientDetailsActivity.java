...
public class PatientDetailsActivity extends FragmentActivity implements
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public CharSequence getPageTitle(int position) {
			switch (position) {
			case 0:
				return getString(R.string.chart_section).toUpperCase();
			case 1:
				return getString(R.string.record_section).toUpperCase();
			case 2:
				return getString(R.string.contact_section).toUpperCase();
			}
			return null;
		}
	}
